...
void readJapanMap() {
    fstream japanMap;
    japanMap.open(R"(C:\Users\natan.chachko\CLionProjects\japan\japanMap.txt)", ios::in);
    if (japanMap.is_open()) {
        string tp;
...
void readQuakesMap() {
    fstream quakesMap;
    quakesMap.open(R"(C:\Users\natan.chachko\CLionProjects\japan\quakesMap.txt)", ios::in);
